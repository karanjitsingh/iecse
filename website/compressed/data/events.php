<style>
#poster_container{position:absolute}#poster_container .poster{height:100%;width:auto;background-size:cover;transform-origin:50% 50%;cursor:pointer;position:relative}#poster_container .animate{transition:opacity ease-out .4s,transform ease-out .4s,margin-left ease-out 1s}#poster_container .poster img{max-height:100%}#poster_page img{height:500px}#poster_container .poster div.tape{background:url(/res/tape.png) 0 0/cover;position:absolute}#poster_container div.zoom{height:2500px!important;width:2500px!important;margin-left:-1250px!important;margin-top:-1250px!important}#zoom_container div{transition:all ease-in .2s}#zoom_container{position:absolute;width:0;height:0;left:50%;top:50%}#zoom_container div{border-radius:500%;margin-left:0;margin-top:0;width:0;height:0;background:rgba(0,0,0,.8);cursor:default}#poster_page{position:fixed;height:100%;width:100%;display:none;z-index:1;opacity:0;transition:opacity ease-out .4s}#poster_page.visible{display:block;opacity:1}.poster_close{position:absolute;top:50px;height:30px;width:30px;right:50px;cursor:pointer}.poster_close svg{height:100%;width:100%}.arrow_container a svg,.arrow_container a:active svg,.arrow_container a:visited svg{fill:#fff;stroke:#fff;opacity:.3;transition:opacity ease-out .1s;cursor:pointer}.arrow_container a:hover svg{opacity:.8}
</style>
