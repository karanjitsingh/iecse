<div style="position:absolute; bottom:10%; right:4%; width:70%; height:175px;">
    <style>
        ...
        #team_1, table.page_dot td:nth-child(1) div{
            ...
            -moz-animation: fadeInOutTeam1 10s ease-out;
            -moz-animation-iteration-count: infinite;
            animation: fadeInOutTeam1 10s ease-out;
        ...
        #team_2, table.page_dot td:nth-child(3) div {
            ...
            -webkit-animation-iteration-count: infinite;
            -moz-animation: fadeInOutTeam2 10s ease-out;
            -moz-animation-iteration-count: infinite;
            animation: fadeInOutTeam2 10s ease-out;
            animation-iteration-count: infinite;
            opacity: 0;
        }
